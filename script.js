document.addEventListener("DOMContentLoaded", function () {
  ...
  document.documentElement.setAttribute(
    "data-theme",
    prevActiveTheme ? prevActiveTheme : "light"
  );
  var toggleTheme = document.getElementsByClassName("theme-color-toggle")[0];
  ...
  // Smooth scroll
  document
    .querySelectorAll('.header .nav .nav-links a[href^="#"]')
...
document.contactForm.addEventListener('submit', function(e) {
  ...
  if(validateForm()) {
    ...
    fetch('https://contact-forms.ibrahimkiri.workers.dev', requestOptions).then(function(response) {response.text()})
